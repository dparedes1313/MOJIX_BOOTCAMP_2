...
st.header('Example')
st.code("<pre><span data-selectable-paragraph="">str=&rdquo;hello world!&rdquo;<br /></span><span data-selectable-paragraph="">a=str[::-1]<br /></span><span data-selectable-paragraph="">print(a)</span></pre>")
st.code("string.split()")
st.code("print(l)")
st.write("<h2><p>Output</p></h2>", unsafe_allow_html=True)
st.code("[‘hello’, ‘world’]")
