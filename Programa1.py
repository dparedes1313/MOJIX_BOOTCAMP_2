...
st.write("<h2><pre>If you want to split the components of a string into a list you can do that easily using the split() function in python. This will make the string operations a lot easier!</pre></h2>", unsafe_allow_html=True)
st.header('Example')
